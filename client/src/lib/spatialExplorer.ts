...
export const GEO_OVERLAY_POINTS: GeoOverlayPoint[] = [
  { id: "kaifeng-prefecture", name: "开封", ancientName: "开封府 · 东京", kind: "州县", layerIds: ["administrative"], x: 33, y: 15, period: "960—1127", description: "北宋都城及其府城阅读锚点。用于串联东京城市、北方关系与靖康危局，不呈现完整辖区边界。", eventIds: ["northern-song", "chanyuan", "huizong-art", "jingkang"], cityId: "dongjing" },
  { id: "jianghuai-counties", name: "江淮腹地", ancientName: "江淮州县", kind: "州县", layerIds: ["administrative", "waterways"], x: 50, y: 35, period: "北宋中期", description: "以江淮州县作为农业、水路与都城供给的阅读锚点；不将其当作一条精确行政边界。", eventIds: ["champa-rice", "iron-production"] },
  { id: "linan-prefecture", name: "杭州", ancientName: "临安府", kind: "州县", layerIds: ["administrative", "waterways"], x: 67, y: 55, period: "1138—1276", description: "南宋行在与都城所在的府城阅读锚点。水路、市场与西湖周边城市生活可在此并读。", eventIds: ["linan", "zhu-xi", "linan-societies", "linan-fall"], cityId: "linan" },
  { id: "mingzhou-prefecture", name: "宁波", ancientName: "明州", kind: "州县", layerIds: ["administrative", "ports"], x: 83, y: 60, period: "南宋时期", description: "明州既是州府阅读锚点，也指向浙东的港口联系；本站不以此复原港区范围。", eventIds: ["southern-sea-routes"], cityId: "mingzhou" },
  { id: "quanzhou-prefecture", name: "泉州", ancientName: "泉州府", kind: "州县", layerIds: ["administrative", "ports"], x: 64, y: 84, period: "两宋时期", description: "泉州的府城与市舶、港口记录在此并读。它是海贸网络的入口之一，不代表所有沿海经验。", eventIds: ["southern-sea-routes", "zhu-fan-zhi", "song-shipwreck"], cityId: "quanzhou" },
  { id: "grand-canal-terminal", name: "杭州", ancientName: "大运河终端", kind: "运河", layerIds: ["waterways"], x: 61, y: 49, period: "两宋时期", description: "杭州位于大运河南端，作为贸易与城市生活的阅读锚点；线条仅表达水路关系。", eventIds: ["linan", "linan-societies"], cityId: "linan" },
  { id: "zhedong-waterway", name: "浙东", ancientName: "浙东水网", kind: "运河", layerIds: ["waterways"], x: 75, y: 59, period: "南宋时期", description: "以浙东水网示意临安与明州的水路联系，避免将其误读为精确河道复原。", eventIds: ["linan", "southern-sea-routes"], cityId: "mingzhou" },
  { id: "quanzhou-port", name: "泉州", ancientName: "刺桐港", kind: "港口", layerIds: ["ports"], x: 68, y: 81, period: "两宋时期", description: "宋代重要港口的阅读锚点。赵汝适、《诸蕃志》和1277海船考古提供不同性质的资料切片。", eventIds: ["zhu-fan-zhi", "song-shipwreck"], cityId: "quanzhou" },
  { id: "mingzhou-port", name: "宁波", ancientName: "明州港", kind: "港口", layerIds: ["ports"], x: 85, y: 65, period: "南宋时期", description: "以明州港提示江南都城、浙东水路与沿海贸易的关联，不代表单一贸易航线。", eventIds: ["southern-sea-routes"], cityId: "mingzhou" },
  { id: "southeast-coast", name: "东南海域", ancientName: "沿海航路", kind: "港口", layerIds: ["ports"], x: 72, y: 91, period: "12—13世纪", description: "面向南海与印度洋的海上能力自12世纪起持续发展；本站以沿海航路作为主题阅读层，而非航行路径复原。", eventIds: ["southern-sea-routes", "zhu-fan-zhi", "song-shipwreck"] },
];
