...
> = {
  制度: {
    ...
    north: ["科举取士扩大士人进入政府的路径", "1069—1072：王安石新法触及财政、官员训练与军政", "新法争论成为北宋政治的重要张力"],
    south: ["南宋政权在南方延续中央治理", "行在临安成为新的行政与城市重心", "政权南迁改变了资源与交通的组织方式"],
  ...
  技术: {
    ...
    north: ["雕版印刷降低书籍复制的门槛", "11世纪：毕昇以胶泥制作活字", "农业、铁业、印刷等领域并行发展"],
  ...
  城市: {
    ...
    south: ["1138：临安成为行在所", "城内水路与运河共同组织物资流通", "明州、泉州等港口与海上贸易网络相连"],
  ...
  外交: {
    ...
    north: ["1005：宋辽缔约，边境关系进入相对稳定期", "北方政局一直影响北宋财政与军事安排", "1127成为从北方都城转向江南的分水岭"],
    south: ["南宋与北方政权长期对峙", "临安与明州的距离强化了港口的战略意义", "泉州等沿海城市连接面向海外的航路"],
